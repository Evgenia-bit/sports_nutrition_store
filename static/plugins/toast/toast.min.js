class Toast {
    constructor(t) {
        this._title = !1 !== t.title && (t.title || "Title"), console.log(this._title), this._text = t.text || "Message...", this._theme = t.theme || "default", this._autohide = t.autohide && !0, this._interval = +t.interval || 5e3, console.log(this._title), this._create(), this._el.addEventListener("click", t => {
            t.target.classList.contains("toast__close") && this._hide()
        }), this._show()
    }

    _show() {
        this._el.classList.add("toast_show"), this._autohide && setTimeout(() => {
            this._hide()
        }, this._interval)
    }
